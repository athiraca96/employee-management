                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employees.update', $employee->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone', $employee->phone) }}" required pattern="^\d{10}$" title="Please enter a 10-digit phone number">
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <!-- Only allow password change if the employee wants to update the password -->
                        <div class="row mb-3">
